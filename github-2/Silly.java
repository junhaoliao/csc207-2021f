...
public class Silly implements Comparable<Silly>{
     ...
     *
     * Creates a new Silly object.
     * This constructor takes in 2 Strings, concatenate them into one and assign to this.name
     *
     * @param firstString first string to concatenate with
     * @param secondString second string to concatenate with
     */
